...
#define TPD_BUTTON_HIGH        (40)
#define TPD_BUTTON_WIDTH        (80)
//#define key_4           420,850
//#define TPD_KEYS        {KEY_BACK, KEY_HOME, KEY_MENU, KEY_SEARCH} KEY_HOMEPAGE
#define TPD_KEYS        {KEY_MENU,KEY_BACK ,KEY_HOMEPAGE}
#define TPD_KEYS_DIM    {{key_1,20,20},{key_2,20,20},{key_3,20,20}}
...
void fts_get_upgrade_array(void);
		...
		extern unsigned int gsl_gesture_init(void);
		extern int gsl_gesture_flag;
#endif
