...
//---------------------------------------------------------
extern unsigned int eta6937_reg_config_interface (u8 RegNum, u8 val);

extern unsigned int eta6937_read_interface (u8 RegNum, u8 *val, u8 MASK, u8 SHIFT);
extern unsigned int eta6937_config_interface (u8 RegNum, u8 val, u8 MASK, u8 SHIFT);
extern unsigned int eta6937_config_interface_liao (u8 RegNum, u8 val);
