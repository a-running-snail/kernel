...
static struct stk_alsps_hw cust_alsps_hw = {
	...
	//.i2c_addr   = {0xCE, 0x00, 0x00, 0x00},	/*STK3338-V*/
	...
	.psctrl_val = 0xB2,		/* ps_persistance=4, ps_gain=64X, PS_IT=0.391ms */
	.alsctrl_val = 0x32,	/* als_persistance=1, als_gain=64X, ALS_IT=50ms */
	.ledctrl_val = 0x40,	/* 100mA IRDR, 64/64 LED duty */
	.wait_val = 0x0F,		/* 50 ms */
    .ps_high_thd_val = 800,
    .ps_low_thd_val = 600,
};
struct stk_alsps_hw *stk3x3x_get_cust_alsps_hw(void) {
