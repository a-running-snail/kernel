...
#if defined(JD9365_HD720P_DSI_VDO_YG_Q6023)
	&jd9365_hd720p_dsi_vdo_yg_q6023_lcm_drv,
#endif

#if defined(HCT_FT8006M_HD_DSI_VDO_AUO_57)
	&hct_ft8006m_hd_dsi_vdo_auo_57_drv,
#endif

/*prize-liuqingwen 20180411 add start*/
#if defined(ILI9881C_HD_DSI_VDO_HSD)
  &ili9881c_hd_dsi_vdo_hsd_lcm_drv,
#endif
/*prize-liuqingwen 20180411 add end*/
