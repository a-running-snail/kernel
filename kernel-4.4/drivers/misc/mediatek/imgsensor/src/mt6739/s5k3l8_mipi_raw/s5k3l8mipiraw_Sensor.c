...
static int tekhw_s5k3l8_mirror = 0xff;/*add by xunhu andy andy20160720 at 22:48*/
static int tekhw_s5k3l8_color =0xff;
...
#if 1//def XUNHU_LPS_TEKHW_SUPPORT
...
#ifdef XUNHU_LPS_TEKHW_SUPPORT
    if (0xff != tekhw_s5k3l8_mirror)
    {
	    set_mirror_flip(tekhw_s5k3l8_mirror);
    }
#endif
	return ERROR_NONE;
}	/*	preview   */
...
/*add by xunhu andy andy20160720 at 22:51 begin*/
#ifdef XUNHU_LPS_TEKHW_SUPPORT	
static void   xun_hardware_getparams(void) 
{
    tekhw_camera_data* tekhw_s5k3l2_ptr = tekhw_get_appointed_camera_ptr(SENSOR_DRVNAME_S5K3L8_MIPI_RAW);/*add by xunhu andy andy20160720 at 22:56*/
    if ((tekhw_s5k3l2_ptr != NULL) && (tekhw_s5k3l2_ptr->set_mirror.size > 0))
    {
        tekhw_s5k3l8_mirror = *(tekhw_u16*)tekhw_s5k3l2_ptr->set_mirror.buffer;
    }
    if ((tekhw_s5k3l2_ptr != NULL) && (tekhw_s5k3l2_ptr->set_color.size > 0))
    {
		tekhw_s5k3l8_color= *(tekhw_u16*)tekhw_s5k3l2_ptr->set_color.buffer;
    }
}
#endif
...
if(tekhw_times == 0)
	...
	if(tekhw_s5k3l8_color!=0xff)
	{
		sensor_info->SensorOutputDataFormat = tekhw_s5k3l8_color;
	}
tekhw_times =1;
#endif
