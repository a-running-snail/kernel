...
#if defined(SP2609_MIPI_RAW_SUB)
{	
		SENSOR_DRVNAME_SP2609_MIPI_RAW_SUB,
		1,
		{
			{SensorMCLK, Vol_High, 0},
			{RST, Vol_Low, 0},
...
{	
	...
	{
		SENSOR_DRVNAME_OV5650_MIPI_RAW,
		1,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
...
{	
...
#endif
#if defined(IMX190_MIPI_RAW_SUB)
	{
		SENSOR_DRVNAME_IMX190_MIPI_RAW_SUB,
		-1,
		{
			{SensorMCLK, Vol_High, 0},
			{AVDD, Vol_2800, 10},
...
#if defined(OV20880_MIPI_RAW)
	{
...
#endif
#if defined(GC030A_MIPI_RAW_SUB)
		{
			SENSOR_DRVNAME_GC030A_MIPI_RAW_SUB,
			-1,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_High, 5},
...
#endif
#if defined(GC8024_2LAN_MIPI_RAW)
		{
			SENSOR_DRVNAME_GC8024_2LAN_MIPI_RAW,
			-1,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_High, 5},
...
#endif
#if defined(GC5025_MIPI_RAW_SUB)
		{
			SENSOR_DRVNAME_GC5025_MIPI_RAW_SUB,
			-1,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_Low, 5},
		...
		{
			SENSOR_DRVNAME_GC2385_MIPI_RAW_SUB,
			1,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_Low, 5},
...
#endif
#if defined(OV9760_MIPI_RAW_SUB)
		{
			SENSOR_DRVNAME_OV9760_SUB_MIPI_RAW,
			1,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_Low, 5},
...
#endif
#if defined(OV9762_MIPI_RAW_MAIN)
		{
			SENSOR_DRVNAME_OV9762_MIPI_RAW_MAIN,
			0,
			{
				{SensorMCLK, Vol_High, 5},
				{PDN, Vol_Low, 5},
...
#if defined(GC8034MIPI_SENSOR_ID)
		{
...
#if defined(HI544MIPI_SENSOR_ID)
		{
...
#if defined(OV5648MIPI_SENSOR_ID)
		{
